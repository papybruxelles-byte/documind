...
4. Add the variables shown in `.env.example` in Render's Environment section. For `FIREBASE_SERVICE_ACCOUNT`, paste the full, one-line JSON contents of the Firebase service-account key file.
